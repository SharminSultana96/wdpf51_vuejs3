                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="product_name" v-model="formValues.p_name">
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <textarea v-model="formValues.p_details" id="product_details" cols="30" rows="6" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="number" class="form-control" id="product_price" v-model="formValues.p_price" >
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="number" class="form-control" id="product_stock" v-model="formValues.p_stock">
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <select v-model="formValues.p_category" id="product_category" class="form-control">
...
export default {
  ...
  methods: {
    edit_product(product){
      ...
      this.formValues.p_category = product.product_category;
    ...
    product_submit(){
      ...
      //{prod_details:this.formValues}
      {
        ...
        product_category:this.formValues.p_category,
